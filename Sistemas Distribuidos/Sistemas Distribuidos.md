...
Un observación relevante es que al estar tratando con nodos independientes no hay un **[[Reloj físico|reloj global]]**, sino que cada [[Componente|componente]] tiene su propia noción del tiempo. La falta de esta referencia común lleva a preguntas fundamentales en lo que respecta a la **sincronización y coordinación** dentro del sistema.
