...
Redis admite tareas de [[Arquitecturas publish-subscriber|publicación y suscripción]] con correspondencia de patrones y una variedad de estructuras de datos, como listas, conjuntos ordenados y hashes. Eso le permite a Redis respaldar salas de chat de alto rendimiento, streaming de comentarios en tiempo real, actividades en redes sociales e intercomunicaciones entre servidores. La estructura de datos de Listas de Redis facilita la implementación de una cola liviana. Y como has listas ofrecen operaciones atómicas, así como capacidades de bloqueo, resultan aptas para una variedad de aplicaciones que requieren un agente de mensajes fiable o una lista circular.  
...
### AOF advantages
-   Using AOF Redis is much more durable: you can have different fsync policies: no fsync at all, fsync every second, fsync at every query. With the default policy of fsync every second, write performance is still great. fsync is performed using a background thread so you can only lose one second worth of writes.
